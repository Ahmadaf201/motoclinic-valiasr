const API_URL = "https://motoclinic-api.onrender.com/api?v=2";
...
async function saveMotorcycle() {
  ...
  try {
    ...
    const response =
      await fetch(`${API_URL}/motorcycles`, {
